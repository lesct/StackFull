    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-9 main">
            <ul class="nav nav-tabs nav-tabs-zen mb10 mt30">
                <li role="presentation"  class="active"><a href="<?php echo U('Home/Index/stayfoolish');?>">最热的</a></li>
                <li role="presentation" ><a href="<?php echo U('Home/Index/stayfoolish_new');?>">最新的</a></li>
