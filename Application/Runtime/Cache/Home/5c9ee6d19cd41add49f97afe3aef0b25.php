...
<div class="form_user">
    <form method="post" action="<?php echo U('Home/User/login_submit');?>" >
        ...
        <div class="form-group">
            <div id="test_img">
                <img src="<?php echo U('Home/User/vcode');?>" height="45px" id="code"/>
            </div>
...
<script>
    $(document).on('click','#code',function(){
        $.get("<?php echo U('Home/User/vcode');?>" , function (){
            $('#test_img').html('<img src="<?php echo U('Home/User/vcode');?>" height="45px" id="code"/>');
        });
    });
