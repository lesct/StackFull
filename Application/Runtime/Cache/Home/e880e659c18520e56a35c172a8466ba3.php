<?php if (!defined('THINK_PATH')) exit();?><!--stayfoolish页面，求知，问答-->
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/StackFull/Public/hungry.css" />
...
<nav class="navbar navbar-dark bg-primary" style="background-color: #4285F4;" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo U('home/index/index');?>" style="color: #ffffff;">StackFull</a>
    ...
    <ul class="nav navbar-nav">
        <li class="active">
            <a class="" href="<?php echo U('home/index/stayfoolish');?>">StayFoolish</a>
        </li>
        <li class="">
            <a class="" href="<?php echo U('home/index/stayhungry');?>">StayHungry</a>
        </li>
        <li class="">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-9 main">
            <ul class="nav nav-tabs nav-tabs-zen mb10 mt30">
                <li role="presentation" ><a href="<?php echo U('Home/Index/stayfoolish');?>">最热的</a></li>
                <li role="presentation" class="active"><a href="<?php echo U('Home/Index/stayfoolish_new');?>">最新的</a></li>
            </ul>
